...
if (isset($_POST['submit'])) {
    ...
    $postAuthor = "abdelrahman";
    /*---- image*/
    $imageName = $_FILES['postImage']['name'];
    $imageTmp = $_FILES['postImage']['tmp_name'];

    if (empty($_POST['postTitle'])) {
        $msg = 'pleas write postTitle!';
    } elseif (empty($_POST['postContent'])) {
        $msg = 'pleas write post of content!';
    } else {
        $postImage = rand(0, 1000) . " " . $imageName;
        move_uploaded_file($imageTmp, "images\\" . $postImage);
        $query = "INSERT INTO posts(postTitle,	postCategory,	postImage,	postContent,postAuthor) VALUES ('$title','$postCategory','$postImage','$postContent','$postAuthor')";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="home.php.php">Blog</a>
                        ...
                        <form class="add" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="formGroupExampleInput"
                                    placeholder="write Title" name="postTitle">
                                <select class="form-control" id="m1" name="postCategory">
                                    <?php
                                ...
                                <div class="form-group" id="m2">
                                    <label for="exampleFormControlFile1">Photo of the article</label>
